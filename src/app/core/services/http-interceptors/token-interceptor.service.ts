...
export class TokenInterceptorServices implements HttpInterceptor {
    ...
    private doRefreshToken(req: HttpRequest<any>, next: HttpHandler): Observable<HttpSentEvent | HttpHeaderResponse | HttpProgressEvent | HttpResponse<any> | HttpUserEvent<any> | any> {
